...
namespace CRUDSimpleProjectPart_1.Web.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="EmployeeID,Name,City,Address")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="EmployeeID,Name,City,Address")] Employee employee)
        {
            if (ModelState.IsValid)
            {
